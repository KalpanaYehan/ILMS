...
function Publishers() {
  ...
  return (
    <>
      ...
      <div className="my-8">
        <h2 className="font-bold text-gray-900 text-center text-2xl">
          Publishers
        </h2>
        ...
        <form className="flex flex-row gap-4 pb-10 pt-5 mx-w-l m-auto  justify-center ">
          ...
          <div className="mb-4">
            <span className="block text-gray-900 text-lg font-bold mb-2">
              Sort Field:
            </span>
            <select
              name="field"
        ...
        <div className="mx-auto px-[15%] min-h-24">
          <div className="grid grid-cols-1 gap-4">
            {publishers.map((publisher) => (
              <div
                className="flex py-2 px-4 border border-gray-300 rounded-3xl shadow-md bg-primary/20"
      ...
      <PublisherDeleteModal
        ...
        bookId={selectedPublisherId}
        refreshBooks={refreshPublishers}
      ></PublisherDeleteModal>
      <Footer />
    </>
  );
