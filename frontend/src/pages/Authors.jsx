  ...
  return (
    <>
              ...
              >
                <div className="w-[10%] mr-6">
                  <img
                    src={`${author.Img_url}`}
                    alt="pic"
                    className="rounded-full w-20 h-20  mx-auto my-auto"
                  />
                </div>
                ...
                <div className="flex items-center gap-2">
                  <Link
                    to={`/books/Authors/edit/${author.Author_ID}`}
      ...
      <AuthorDeleteModel
        ...
        bookId={selectedAuthorId}
        refreshBooks={refreshAuthors}
      ></AuthorDeleteModel>
      <Footer />
    </>
  );
