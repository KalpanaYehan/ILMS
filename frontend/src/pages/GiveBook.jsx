...
function GiveBook() {
  ...
  return (
    <>
      <Navbar/>
      <h1 className='text-4xl font-bold text-gray-900 text-center mt-3 mb-4'>Isuue a Book</h1>
...
{bookDetails && (
        <div className="my-5 mx-2 block text-gray-700 text-md font-semibold mb-2">
          ...
          <p className="font-semibold text-gray-900 text-lg mb-1"><strong>Availability:</strong> {bookDetails.availability}</p>
