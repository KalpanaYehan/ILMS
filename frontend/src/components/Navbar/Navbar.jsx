            ...
            <div className='py-2 mx-auto max-w-7xl'>
                <div className='flex items-center justify-between pl-10 pr-10'>
                    ...
                    >
                        ...
                        <div className="relative">
                            <button data-testid="navbar-user-icon" onClick={toggleDropdown} className='flex items-center justify-center gap-2 text-2xl font-bold tracking-wider sm:text-3xl'>
                                <img src={User2} alt="user" className='duration-200 rounded-full cursor-pointer w-14 hover:scale-105' />
                            </button>
                            {dropDownOpen && (
